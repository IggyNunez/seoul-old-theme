...
document.addEventListener('DOMContentLoaded', function () {
  const wishlistIcons = document.querySelectorAll('.custom-wishlist-icon');
  ...
  // Highlight already added products on page load
  let wishlist = JSON.parse(localStorage.getItem('wishlist')) || [];
  wishlist.forEach(function(handle) {
    const icon = document.querySelector(`.custom-wishlist-icon[data-product-handle="${handle}"]`);
    if (icon) {
